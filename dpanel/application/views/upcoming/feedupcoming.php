        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label>Upcoming Event  <span style="font-size: 11px; color: #808080; font-weight: normal; font-style: italic">max <span id='wp' style='color:#ff0000; font-weight:bold'>450</span> characters allowed</span></label></label>
                        <?php
                        $data = array(
                            'rows' => '3',
                            'autocomplete' => 'off',
