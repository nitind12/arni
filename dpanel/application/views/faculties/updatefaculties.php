...
<script>
    function get_faculty(cmbData) {
        ...
        if (cmbData.value !== '0') {
            ...
            url_=site_url_ + "/faculty/getFaculty/" + cmbData.value;
            //alert(url_);
            $.ajax({
                url: url_,
                type: 'GET'
                ...
                //alert(obj.fac[0].FACULTY_NAME);
                $("#txtDesig").val(obj.fac[0].DESIG);
                $("#txtfacID").val(cmbData.value);
                $("#txtQualification").val(obj.fac[0].LAST_QUALIF);
                $("#txtSummary").val(obj.fac[0].SUMMARY);
                $("#txtEmail").val(obj.fac[0].EMAIL);
                $("#txtMobile").val(obj.fac[0].MOBILE);
                $("#facName").html(obj.fac[0].FACULTY_NAME);
                if (data.photo != 'x') {
                    var path = base_url_ + '_assets_/faculty/photo/' + obj.fac[0].PHOTO_;
                } else {
