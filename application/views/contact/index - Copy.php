                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <ol class="breadcrumb">
                                            <li><a href="<?php echo site_url('arni');?>">Home</a></li>
                                            <li class="active"><?php echo $titleMain;?></li>
                                        </ol>
                                    </div>
                                </div><!-- /.row -->
                            </div><!-- /.container-fluid -->
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <header class="entry-header">       
                                        <h1 class="entry-title"><a href="#"><?php echo $titleMain; ?></a></h1>
                                    </header><!-- /.entry-header -->
                                     <img src="<?php echo base_url('assets/img/contact.jpg'); ?>" class="img-responsive" alt="Contact us, Amrapali Group of Institutes"> 
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="mini-contact">
                                        ...
                                        <span style="color:#FF5733; font-size:1.4em">Toll-Free: 1800 180 4027 </span><br>
                                        <b>Mobile</b>
                                        </div>
                                        <div class="col-md-6" style="background: #FFFAC1; border-radius: 5px; color: #000">
                                            +91 - 9837302005 <br> +91 - 6396847002 <br> +91 - 9521655000 <br> +91 - 9520688000
                                        </div>
                                        <div class="col-md-6" style="background: #FFFAC1; border-radius: 5px; color: #000">
                                            +91 - 9759670200 <br> +91 - 9759670300 <br>  +91 - 9759670400 <br>  +91 - 9759670500  <br> 
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>Faculty of Hospitality Management</td>
                                                <td>(+91)-8171170007</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Faculty of Technology and Computer Applications</td>
                                                <td>(+91)-8755683945, (+91)-9415892932</td>
                                                <td>director.aits@amrapali.ac.in</td>
                                            </tr>
                                            <tr>
                                                <td align="center">3</td>
                                                <td>Prof. (Dr.) Ritvik Dubey, Director</td>
                                                <td>Faculty of Commerce and Business Management</td>
                                                <td>(+91)-8126096191</td>
                                                <td>director.fcbm@amrapali.ac.in</td>
                                            </tr>
                                            <tr>
                                                <td align="center">4</td>
                                                <td>Dr. Garima Garg, Principal</td>
                                                <td>Faculty of  Pharmacy & Sciences</td>
                                                <td>(+91)-9927034240</td>
                                                <td>principal.pharmacy@amrapali.ac.in</td>
                                            </tr>
                                            <tr>
                                                <td align="center">5</td>
                                                <td>Dr. Pankaj shah, Principal</td>
                                                <td>Faculty of  Education</td>
                                                <td>(+91)-9568222007</td>
                                                <td>principal.bed@amrapali.ac.in</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
