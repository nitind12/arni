                                                ...
                                                <section class="panel">                                                                
                                                    ...
                                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                                        <figure style="background: #f3f3f3;margin-top: 2em;padding:.5em;">
                                                            <div class="css-team-avatar" align="center">     <a href="<?PHP echo site_url('getAlumnibyID/' . $item->id); ?>" target='_blank'>            
                                                                ...
                                                                <p class="cross"><a href="<?PHP echo site_url('deleteAlumniProfile/' . $item->id); ?>" class="btn-danger">&nbsp;X&nbsp;</a></p>
                                                                <?php if ($item->status == '0') { ?>
                                                                    <p class="enable"><a href="<?PHP echo site_url('enabledDisableAlumni/1/' . $item->id); ?>" class="btn-warning">disabled</a></p>
                                                                <?php } else { ?>
                                                                    <p class="disable"><a href="<?PHP echo site_url('enabledDisableAlumni/0/' . $item->id); ?>" class="btn-info">enabled</a></p>
                                                                <?php } ?>           
                                                            </div>
