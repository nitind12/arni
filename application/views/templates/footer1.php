...
<style>
    ...
    .admission_{
     ...
     position: fixed; right:-15px; top: 43%; z-index: 9999
...
<div class="sticky_footer">
    ...
    <a href="<?php echo site_url('admissions/applynow');?>" style="color: #f0f0f0">Apply online</a> <span style="color: #707070">|</span>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.admission_').hover(function(){
             ...
             $('.admission_').css('right', '-10px');

        }, function() {

            $('.admission_').css('right', '-15px');
        ...
        $('#frmOnlineRegister').submit(function(){
            return true;
          var url_ = site_url_ + 'agi/checkcaptcha';
          var data_ = 'captcha='+$('#captcha').val();
          
          $('#captchamessage').html('Please wait. Its checking captcha first.');
          $.ajax({
            type: 'POST',
            url: url_,
            data: data_,
            success: function(data){
                if(data == true){
                    ...
                    $('#captchamessage').html('Please enter correct captcha');
                }
            }
          });
...
<a href="<?php echo site_url('admissions/applynow');?>" class="admission_"><img src="<?php echo base_url('assets/img/admission-right.png');?>?version=1.5" style="width: 46px"></a>
...
<script src="<?php echo base_url('assets/js/main.js'); ?>?ver=8.1"></script>
