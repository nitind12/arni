                        ...
                        <div class="content-wrapper">   
                            <div class="inner-content">
                                <div class="row">
									<center>
										<div class="thanks">
											Dear <?php echo $ticket->name; ?>, <br> thanks for registering for <br><?php echo $ticket->course; ?> course at Amrapali Group of Institutes.
										</div>
										<div class="payment_message">
											We had sent you the registration and payment detail on your <br>registered email-id.
											<br><br>
