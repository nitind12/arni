                                    ...
                                    <div class="col-xs-12 col-md-12 col-sm-12">
                                        <article class="blog-post-wrapper single-article">
                                            <header class="entry-header">       
                                                <a href="<?php echo site_url('logout_online_registration');?>" style="background: #808080; color: #ffff00; border-radius: 5px; padding: 5px 10px; float: right; ">Logout?</a>
                                            ...
                                            <div class="entry-content">
                                                ...
                                                <div style="float: right;"> 
                                                    <a href="<?php echo site_url('getRegistrations/0');?>" style="color: #ff0000">Download Not Confirmed</a> | <a href="<?php echo site_url('/getRegistrations/1');?>" style="color: #009000">Download  Confirmed</a> | 
                                                </div>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table-bordered" style="width:100%;">
                                                                    <tr align="center" style="background-color:#0086B3; color: #ffffff;">
                                                                        <td width="80"><label class="control-label"></label></td>
                                            ...
                                            <td><label class="control-label">Confirm</label></td>
                                                                ...
                                                                <?php if ($totalCount != 0) { ?>
                                                                    ...
                                                                    <tr align="center" id="_del_<?php echo $item->regID;?>" >
                                                                        <td id="del_<?php echo $item->regID;?>" class="delete_me">X</a></td>
                                                ...
                                                <td><a href="<?PHP echo site_url('confirm_registration/' . $item->regID); ?>" class="btn btn-danger" role="button">Confirm <span class="glyphicon glyphicon-wrench"></span></a></td>
                                                                    </tr>
                                                                        <?php }} ?>
                                                                </table> 
                                                            </div>                                                     </div></div>                     
                                            ...
                                            <td><label class="control-label">Address</label></td>
                                                                            ...
                                                                            <?php foreach ($confirmReg as $item1) { ?>
                                                                                <tr align="center" id="_cdel_<?php echo $item1->regID;?>" >
                                                                        <td id="cdel_<?php echo $item1->regID;?>" class="delete_me">X</a></td>
