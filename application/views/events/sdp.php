                    ...
                    <div class="col-xs-12 col-md-12 col-sm-12">
                        <article class="blog-post-wrapper single-article">                                      
                            ...
                            <div class="topnav" id="myTopnav" style="border:#ff0000 solid 0px;">
                              <a href="<?php echo site_url('sdp');?>" <?php if($active == 'activities'){ echo 'class="active"'; } ?>><img src="<?php echo base_url('assets/img/home.png');?>?version=1.2" style="width: 20px"></a>
                              <a href="<?php echo site_url('sdp/activities');?>" <?php if($active == 'grules'){ echo 'class="active"'; } ?>>List of Activities</a>
                              <a href="<?php echo site_url('sdp/benefits');?>" <?php if($active == 'benefits'){ echo 'class="active"'; } ?>>Benefits</a>
                              <a href="<?php echo site_url('sdp/howtoregister');?>" <?php if($active == 'howtoregister'){ echo 'class="active"'; } ?>>How to Register</a>
                              <a href="<?php echo site_url('sdp/register');?>" <?php if($active == 'register'){ echo 'class="active"'; } ?>>Online Registration</a>
                              <a href="https://www.youtube.com/watch?v=g37UJscI71w"><b style="color: #ffc4ff">Good Wishes</b></a>
                            ...
                            <div class="entry-content" style="overflow: hidden;border:#ff0000 solid 0px">
                                ...
                                <img src="<?php echo base_url('assets/img/sdp.png');?>?version=1.0" />
                                <?php } ?>
                            </div>
                            <?php } ?>
                            <div class="entry-content" style="overflow: hidden;border:#ff0000 solid 0px">
                                  <div style="clear: both; height: 10px"></div>
                                  <?php $this->load->view('events/innerpages_sdp/'.$inner_page, $data); ?>
                                  <div style="clear: both; height: 10px"></div>  
                            </div>  
                        </article>                                            
                    </div><!-- /.col-md-9 -->
